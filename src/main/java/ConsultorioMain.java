...
import java.util.Scanner;
    ...
    public class ConsultorioMain {
        ...
        public static List<com.computacionJava.evidencia.Usuario> usuarios;
        ...
        public static void cargarUsuarios() {
            ...
            usuarios.add(new com.computacionJava.evidencia.Usuario(1, "carlos", "1234"));
            usuarios.add(new com.computacionJava.evidencia.Usuario(2, "sofia", "1234"));
            usuarios.add(new com.computacionJava.evidencia.Usuario(2, "ithan", "0000"));
            usuarios.add(new com.computacionJava.evidencia.Usuario(2, "alfredo", "0000"));
        ...
        public static void save() {
            try {
                ...
                String ruta = "C:\\Dana\\Trabajos\\Computación Java\\Evidencia\\src\\db\\citas.json";
        ...
        public static void crearCita() {
            ...
            Cita cita = new Cita();
            com.computacionJava.evidencia.Medico medico = new com.computacionJava.evidencia.Medico();
            com.computacionJava.evidencia.Paciente paciente = new com.computacionJava.evidencia.Paciente();
            medico.setId(1);
        ...
        public static String leerArchivo() throws IOException {
            String archivo = "C:\\Dana\\Trabajos\\Computación Java\\Evidencia\\src\\db\\citas.json";
